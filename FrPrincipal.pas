...
begin
  MessageDlg('Deseja CANCELAR a inserÁ„o dos item(s)?',
...
begin
  ...
  try
    ...
    // begin
    // ShowMessage('Informe a observaÁ„o fixa!');
    // exit;
    // end;
...
begin
  ...
  begin
    ...
    begin
      ...
      LItem.Detail := 'Cod.: ' + DMD.cdsProdutoCODPRODUTO.AsString + ' PreÁo: '
  ...
  try
    ...
    try
      ...
      begin
        ...
        Toast('TransferÍncia realizada com sucesso');
      end
      else
      begin
        Toast('Sem registro para realizar operaÁ„o');
      end;
    finally
      MSGHide;
...
begin
  ...
  begin
    ShowMessage('Confirme a ObservaÁ„o primeiro!');
    exit;
  end;

  if TabProdutoResult.ActiveTab = TabVendaItem then
  begin
    ShowMessage('Confirme ou cancele a operaÁ„o!');
    exit;
  end;
...
//  else
//  begin
//    ShowMessage('Configure o endereÁo do servidor!');
//  end;
end;
...
begin
  try
    ...
    begin
      ...
      begin
        ShowMessage
          ('Sabores lanÁados È maoir que a quantidade de sabor escolhida, proceda com a exclus„o dos itens excedente!');
        exit;
      end;
      DMD.cdsVendaItem.First;
      while not DMD.cdsVendaItem.Eof do
  ...
  begin
    case TabGourmet.TabIndex of
      1:
        begin
          Key := 0;
          MessageDlg('Deseja sair da aplicaÁ„o?',
...
begin
  try
    try
      MSGShow('Buscando item(s) para produÁ„o....');
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            LItem.Data[TMultiDetailAppearanceNames.Detail1] := 'CÛdigo: ' +
            ...
            // LItem.Detail := 'CÛdigo: ' + DMD.cdsProdutoProducaoCOD_DAV_PREVENDA.
...
begin
  try
    try
      ...
      begin
        MSGShow('Buscando informaÁıes do cart„o.. Aguarde...');
        ...
        begin
          ...
          ShowMessage('N„o foi encontrado lanÁamentos para esse Cart„o!');
        end;
    ...
    begin
      MSGHide;
      MESAORIGEM := '';
      ShowMessage('Problema pesquisar cartıes! ' + E.Message);
    end;
  end;
...
begin
  try
    ...
    begin
      ShowMessage('N„o existe produto!');
      { ListProdutoGrupo.Items.Clear;
        DMD.cdsProduto.First;
        while not DMD.cdsProduto.Eof do
        begin
        ...
        ' PreÁo: ' + DMD.cdsProdutoPRECO.AsString;
...
begin
  try
    ...
    begin
      ...
      Toast('Finalizando a produÁ„o do Item: ' +
...
begin
  try
    ...
    try
      ...
      MSGShow('Carregando os cartıes! Aguade por favor....');
      ...
      begin
        ...
        begin
          ...
          LItem.Detail := 'PermanÍncia : ' + FormatDateTime('hh:nn',
            (Time - HoraIni));
...
begin
  ...
  begin
    ShowMessage
      ('Escolha outra Cart„o, operaÁ„o n„o È permitida para mesma Cart„o!');
    exit;
  end;
...
begin
  ...
  begin
    ShowMessage('Quantidade de sabores j· foi lanÁada!');
    exit;
  end;
...
begin
  ...
  begin
    ...
    begin
      ...
      LItems := ListProdutoGrupo.Items.Add;
      LItems.Text := TiraAcentos(DMD.cdsProdutoDESC_COMPLETA.AsString);
      LItems.Detail := 'Cod.: ' + DMD.cdsProdutoCODPRODUTO.AsString + ' PreÁo: '
        + DMD.cdsProdutoPRECO.AsString;
...
begin
  ...
  try
    ...
    begin
      ...
      begin
        ShowMessage
          ('VocÍ deve informar o profissional no cadastro de funcion·rio!');
        exit;
      end;
      ...
      begin
        ShowMessage('N„o encontrado o profissional!');
        exit;
      end;
...
begin
  ...
  begin
    ShowMessage('Informe o endereÁo do servidor');
    exit;
  end;
